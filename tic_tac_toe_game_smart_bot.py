...
def pk(board: list) -> list:
    ...
    if (board[0][0] == board[0][1] == "O") and (board[0][2] == ' '):
        ...
        board[0][1] = 'O'
    elif (board[0][2] == board[0][1] == "O") and (board[0][0] == ' '):
        board[0][0] = 'O'
        ...
        board[1][1] = 'O'
    elif (board[1][2] == board[1][1] == "O") and (board[1][0] == ' '):
        board[1][0] = 'O'
        ...
        board[2][1] = 'O'
    elif (board[2][2] == board[2][1] == "O") and (board[2][0] == ' '):
        board[2][0] = 'O'
    ...
    ############
        ...
        board[2][0] = 'O'
    elif (board[2][0] == board[1][0] == "O") and (board[0][0] == ' '):
        board[0][0] = 'O'
        ...
        board[2][1] = 'O'
    elif (board[2][1] == board[1][1] == "O") and (board[0][1] == ' '):
        board[0][1] = 'O'
        ...
        board[2][2] = 'O'
    elif (board[2][2] == board[1][2] == "O") and (board[0][2] == ' '):
        board[0][2] = 'O'
    ...
    ############
        ...
        board[2][2] = 'O'
    elif (board[2][2] == board[1][1] == "O") and (board[0][0] == ' '):
        board[0][0] = 'O'
        ...
        board[2][0] = 'O'
    elif (board[2][0] == board[1][1] == "O") and (board[0][2] == ' '):
        board[0][2] = 'O'
    ...
    #"""==========================================================================="""
        ...
        board[0][1] = 'O'
    elif (board[0][2] == board[0][1] == "X") and (board[0][0] == ' '):
        board[0][0] = 'O'
        ...
        board[1][1] = 'O'
    elif (board[1][2] == board[1][1] == "X") and (board[1][0] == ' '):
        board[1][0] = 'O'
        ...
        board[2][1] = 'O'
    elif (board[2][2] == board[2][1] == "X") and (board[2][0] == ' '):
        board[2][0] = 'O'
    ...
    ############
        ...
        board[2][0] = 'O'
    elif (board[2][0] == board[1][0] == "X") and (board[0][0] == ' '):
        board[0][0] = 'O'
        ...
        board[2][1] = 'O'
    elif (board[2][1] == board[1][1] == "X") and (board[0][1] == ' '):
        board[0][1] = 'O'
        ...
        board[2][2] = 'O'
    elif (board[2][2] == board[1][2] == "X") and (board[0][2] == ' '):
        board[0][2] = 'O'
